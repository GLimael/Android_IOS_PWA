...
export default function Figura ({palavraErrada}){
    ...
    const Corda = <AnimatableLine animation={'fadeIn'} x1="200" y1="0" x2="200" y2="140" stroke="brown" strokeWidth="5" />
    const Cabeca = <AnimatableEllipse animation={'fadeIn'} cx="200" cy="150" rx="40" ry="25" fill={colors.shapeColor} />
    const Nack = <AnimatableRect animation={'fadeIn'} width="10" height="50" x="195" y="150" fill={colors.shapeColor} />
    const Bracos = <AnimatableLine animation={'fadeIn'} x1="260" y1="200" x2="140" y2="200" stroke={colors.shapeColor} stroke-Linecap="round" strokeWidth="10" />
    const Corpo = <AnimatableRect animation={'fadeIn'} width="10" height="50" x="195" y="200" fill={colors.shapeColor} />
    const Pernas = <G>
